...
public class FileUploadController {
    ...
    // 파일 저장 : 저장 폴더 생성 -> 해당 경로(웹 경로 -> 시스템 경로)에 파일 저장
    // 이미지를 업로드 -> 웹페이지에서 확인
    ...
    public String submit1(
        ...
        log.info("이름 : " + sname);
        log.info("학번 : " + snum);
        log.info("리포트 파일 이름 : " + report.getOriginalFilename());
        ...
        // 업로드 경로
        // 서버 경로 / uploadfile/report -> webapp 폴더에 updloadfile 폴더 생성
    ...
    public String submit2(
        ...
        // 실제경로
        String dirRealPath = request.getSession().getServletContext().getRealPath(uploadURI); // uploadURI 대신에 "/uploadfile/report" 를 넣어도됨
